...
const groupKeys = ["popularSearches", "cars", "services", "jobs"] as const;
    ...
    <main>
      ...
      <div className="shell home-layout">
        ...
        <div className="home-content">
          ...
          <section className="link-groups">
            {groupKeys.map((key) => (
              <div key={key}>
                <b>{t(`groups.${key}.title`)}</b>
                <p>
                  {([0, 1, 2, 3] as const).map((index) => {
                    const item = t(`groups.${key}.item${index}`);
                    return (
                      <Link
