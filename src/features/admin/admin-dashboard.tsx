...
import { AdminRepository, type AdminDashboardData } from '@/features/admin/admin-repository';
import { Building2, ShieldCheck, Store, UserRound, Users, ClipboardCheck } from 'lucide-react';
  ...
  if (error)
    return (
      <div className={styles.state}>
        <p>{error instanceof ApiError ? error.message : 'Unable to load dashboard data.'}</p>
    ...
    <AdminPageGuard permission={adminPermissions.analytics}>
      <div className={styles.dashboard}>
        <AdminPageHeader
          icon={ShieldCheck}
          eyebrow={t('overview')}
          title={t('administrationDashboard')}
        />
