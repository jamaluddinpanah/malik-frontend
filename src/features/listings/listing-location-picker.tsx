...
export function ListingLocationPicker({ value, onChange }: { value: ListingLocationValue; onChange: (value: ListingLocationValue) => void }) {
  ...
  return <section className={styles.picker} aria-labelledby="listing-location-title">
    ...
    <div className={styles.fields}>
      ...
      <div className={`${styles.wide} ${styles.field}`}><span>{t("administrativeArea")}</span><LocationSelector value={value.administrativeAreaId ?? undefined} onChange={(area: LocationOption) => onChange({ ...value, administrativeAreaId: area.id })} /></div>
