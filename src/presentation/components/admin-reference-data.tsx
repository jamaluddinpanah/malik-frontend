...
import { formatCurrency, formatDateTime } from "@/lib/formatting/locale";
...
import type { LaravelCursorPagination } from "@/types/api";
              ...
              <>
                ...
                >
                  <Button
                    ...
                    onClick={() => setCursor(page?.prev_cursor ?? null)}
                  >
                    <ArrowLeft size={16} />
                    {t("newer")}
                  </Button>
                  <span>{formT("showing", { count: items.length })}</span>
                  <Button
                    size="sm"
                    variant="ghost"
