      ...
      <div className={styles.shell}>
        <div className={styles.columns}>
          ...
          <Column
            title={t("categories")}
            items={[
              { label: shell("vehicles"), href: "/search?category=vehicles" },
              {
                label: shell("realEstate"),
                href: "/search?category=realestate",
              },
              { label: shell("jobs"), href: "/search?category=jobs" },
            ]}
          />
          <Column
            title={t("help")}
        ...
        <div className={styles.bottom}>
          ...
          <span>
            <ShieldCheck size={14} />{" "}
            <LocalizedLink href="/safety">{t("safetyTips")}</LocalizedLink>　
            <LocalizedLink href="/privacy">{t("privacy")}</LocalizedLink>
          </span>
        </div>
      </div>
    </footer>
